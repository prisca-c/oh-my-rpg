...
import { useInventory } from '~/features/game/inventory/hooks/use_inventory'
import { CanItemBePlaced } from '#domain/inventory/can_item_be_placed'
import { useInventoryDragAndDrop } from '~/features/game/inventory/hooks/use_inventory_drag_and_drop'
